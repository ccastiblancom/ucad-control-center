    ...
    <div className="relative min-h-screen w-full pb-12">
      ...
      <div className="relative z-10 max-w-5xl mx-auto mt-4 px-4">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-8 shadow-sm border border-slate-200 mb-8 flex flex-col items-center justify-center min-h-[200px]">
           <Activity className="w-12 h-12 text-[#10b981] mb-4 opacity-20" />
           <p className="text-slate-400 text-sm font-medium">Panel de Control de Resultados Hemato-Oncológicos</p>
        </div>
...
{activeTab === "resultados" && (
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    {/* ACTUALIZADO: Enlace a Neutropenia Febril */}
...
{activeTab === "proceso" && (
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    {/* NUEVO INDICADOR: Publicaciones Científicas */}
...
{activeTab === "experiencia" && (
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    {/* ACTUALIZADO: Enlace a Calidad de Vida */}
